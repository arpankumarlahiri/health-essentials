  ...
  const contactInfo = [
    {
      ...
      title: "Phone Numbers",
      details: [generalDetails.companyPhone, generalDetails.companyPhone2],
      ...
      <section className="bg-gradient-to-br from-healthcare-light-blue to-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Badge className="mb-4 bg-healthcare-blue text-white">
              Get In Touch
            </Badge>
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Contact Our{" "}
              <span className="text-healthcare-blue">Healthcare Experts</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Ready to secure your health with affordable OPD plans? Get your
              free quote today and speak with our experienced healthcare
              consultants.
            </p>
            {selectedPlan && (
              <div className="inline-flex items-center bg-healthcare-green text-white px-4 py-2 rounded-lg">
                ...
                You've selected:{" "}
                <strong className="ml-1">{selectedPlan}</strong>
              </div>
            )}
          </div>
        </div>
            ...
            <Card className="shadow-lg">
              <CardHeader>
                ...
                <p className="text-gray-600">
                  Fill out the form below and our healthcare experts will
                  contact you within 24 hours with a personalized quote and
                  consultation.
                </p>
              </CardHeader>
              <CardContent>
            ...
            <Card className="shadow-lg bg-green-50 border-green-200">
              <CardContent className="p-6 text-center">
                ...
                <Button
                  onClick={() => {
                    const message =
                      "Hi! I'm interested in RTEMPORARY's OPD health plans. Could you help me?";
                    window.open(
                      `https://wa.me/${
                        generalDetails.companyPhone
            ...
            <Card className="shadow-lg bg-healthcare-light-blue border-healthcare-blue">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">
                  We guarantee to respond to all inquiries within 24 hours. For
                  urgent matters, call us directly or use WhatsApp.
                </p>
              </CardContent>
            </Card>
          </div>
