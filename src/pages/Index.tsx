  ...
  const testimonials = [
    {
      ...
      plan: "Humsafar Gold",
      quote:
        "Excellent service! The OPD coverage has saved me thousands on medical bills.",
      rating: 5,
    },
    {
      name: "Rajesh Kumar",
      ...
      plan: "Family Care",
      quote:
        "Perfect for my family. The customer support is outstanding and very helpful.",
      rating: 5,
    },
    {
      name: "Anjali Devi",
      ...
      plan: "Senior Citizen",
      quote:
        "As a senior citizen, this plan gives me peace of mind and great medical care.",
      rating: 5,
    },
  ];
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                asChild
                size="lg"
                className="bg-healthcare-blue hover:bg-blue-600 text-lg px-8 py-3"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-healthcare-blue text-healthcare-blue hover:bg-healthcare-light-blue text-lg px-8 py-3"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We make healthcare accessible and affordable for everyone with our
              comprehensive OPD plans.
            </p>
          </div>
      ...
      <section className="py-16 bg-healthcare-light-blue">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Choose from our carefully designed healthcare plans that suit your
              needs and budget.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center mt-12">
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-healthcare-blue text-healthcare-blue hover:bg-white"
            >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Real experiences from thousands of satisfied customers across
              India.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-16 bg-gradient-to-r from-healthcare-blue to-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Join thousands of satisfied customers who trust RTEMPORARY for their
            healthcare needs. Get your free quote today!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              size="lg"
              variant="secondary"
              className="bg-white text-healthcare-blue hover:bg-gray-100 text-lg px-8 py-3"
            >
              <Link to="/contact">Get Free Quote</Link>
            </Button>
            <Button
